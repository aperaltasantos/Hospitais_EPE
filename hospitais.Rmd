...
# Historical evolution of the EPE Hospitals Arrears {#text-formatting}
***
...
- October 2019 
- Increase in 84.3 M Euros in arreaers, 11.4% increase compared with the last month
- Centro Hospitalar Lisboa Norte, and Centro Hospitalar Coimbra are by far the hospitals with highest arrears
...
mytext <- paste(
   "Hospital: ", sns_map$entidade, "<br/>",
   "Arrears (Millions): ", sns_map$arrears, "<br/>",
   "Monthly var (%): ", sns_map$montly_perc_var, sep="") %>%
  lapply(htmltools::HTML)

# Final Map
m <- leaflet(sns_map) %>% 
  addTiles()  %>% 
  setView( lat=39.80846, lng=-8.09883 , zoom=6) %>%
...
# Arrears variation  {#text-formatting}
***
...
kable(table_monthly_var, 
      caption = "Arrears variation of Portuguese E.P.E. Hospitals ", 
      booktabs = T, 
      digits = 1,
      col.names = c("Year",
                    "Month",
...
kable_styling(latex_options = "striped",
              full_width = F) %>%
  footnote(general = "Agregated monthly and annual arrears of the Portuguese E.P.E. Hospitals") %>%
...
# EPE hospitals in Arrears (Million of Euros) variation{#text-formatting}
***
...
datatable(table_monthly_var_top,
          colnames = c("Year",
                    ...
                    "Annual Arrears Var",
                    "Annual Var (%)"),
          caption = 'Table: EPE Hospital arrears (Million Euros) 2019',
          extensions = 'Buttons', 
          options = list(
    dom = 'Bfrtip',
...
# Top 5 Arrears variation of Portuguese E.P.E. Hospitals {#text-formatting}
***

```{r echo=FALSE,  message=FALSE, warning=FALSE}

kable(table_monthly_var_top5, 
      caption = "Top 5 Arrears variation of Portuguese E.P.E. Hospitals, 2019", 
      booktabs = T, 
      digits = 1,
      col.names = c("Year",
                    "Month",
...
# Top 10 EPE hospitals Arrears {#text-formatting}
***
...
kable(table_monthly_top10,
      caption = "Top 10  Arrears of Portuguese E.P.E. Hospitals, 2019", 
      booktabs = T, 
      digits = 1,
      col.names = c("Year",
                    "Month",
...
kable_styling(latex_options = "striped",
              full_width = F) %>%
  footnote(general = "Monthly arrears of the Portuguese E.P.E. Hospitals")  %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed", "responsive"))
```
$~$
$~$

# Historical evolution of EPE Hospitals Arrears {#text-formatting}
***
...
# Monthly variation of Portuguese E.P.E. Hospitals Arrears {#text-formatting}
***
...
# Relative contribution of each Hospital to total arrears {#text-formatting}
***
...
tree_map +  labs(title = "E.P.E. Hospitals Arrears",
           subtitle = "2019 last month available",
           color='Arrears M',
           caption = "Source: Portal da Transparencia SNS")  + 
  theme(plot.title = element_text(hjust = 0.5), 
        plot.subtitle = element_text(hjust = 0.5)) +
