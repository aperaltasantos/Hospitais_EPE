...
- Novembro de 2019
- Aumento de 76.7 M Euros das dívidas em atraso, aumento de 9.4%% em relação ao último mês
- O Centro Hospitalar Universitário do Porto foi o Hospital que mais aumentou a divida no mes de Novembro (+20.4 M Euros)
- Centro Hospitalar Lisboa Norte (130 M E) e Centro Hospitalar Coimbra (118.7) são de longe os hospitais com maiores dívidas em atraso
...
sns_map <- sns_epe %>% 
  filter(date==as.Date("2019-11-01")) #CHANGE
...
table_monthly_var_top<- sns_epe %>%
  select(year, 
         ...
         annual_var, 
         annual_perc_var) %>%
  filter(year == "2019" & month_name == "November") %>% #CHANGE
